...
connectionString = "mongodb+srv://omkar:<nineleaps>@cluster0.co68d.mongodb.net/myFirstDatabase?retryWrites=true&w=majority"
...
MongoClient.connect(connectionString, { useUnifiedTopology: true })
    .then(client => {
        ...
        firstServerApp.put('/tasks', (req, res) => {
            ...
            tasksCollection.findOneAndUpdate({ name: 'Revanth' }, {
                    $set: {
                        name: req.body.name,
                        task: req.body.task
                    }
